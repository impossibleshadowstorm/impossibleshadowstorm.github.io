...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      <Image
        src="https://avatars.githubusercontent.com/u/67030264?s=400&u=c7b2e20364ba0eb75e1be0eb982631a8816e9cf1&v=4"
        alt="Avatar"
        height="40"
        width="40"
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Sumit Saurav</p>
